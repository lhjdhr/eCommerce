<template>
  <div class="shop-header">
    ...
    <nav class="shop-nav" style="background:url('https://fuss10.elemecdn.com/f/5c/ead54394c3de198d3e6d3e9111bbfpng.png')">
    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <img class="content-image" src="./images/12.jpg">
      <div class="header-content">
        <h2 class="content-title">
          <span class="content-tag">
            <span class="mini-tag">品牌</span>
          </span>
          <span class="content-name">{{storeInfo.storeName}}</span>
